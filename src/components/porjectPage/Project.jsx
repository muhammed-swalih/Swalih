        ...
        <div className=" md:w-1/2 h-full  py-5 px-5 flex flex-col justify-center items-start  ">
          <div className=" gap-5 md:w-full h-full flex flex-col items-start justify-center md:gap-1">
            ...
            <div className=" flex gap-5">
              ...
              <div className=" md:flex flex-col">
                <div className=" md:flex gap-2 items-center">
                  <a href="https://trekkandtravel.com/">
            ...
            <div className=" flex gap-5">
              ...
              <div className=" md:flex flex-col">
                <div className=" md:flex gap-2 items-center">
                  <a href="https://jovial-pavlova-0f7579.netlify.app/">
                    <h1 className=" text-blue-500 text-xl cursor-pointer hover:underline">
                      Netflix clone-
                    </h1>
                  </a>
            ...
            <div className=" flex gap-5">
              ...
              <div className="  md:flex flex-col">
                <div className=" md:flex gap-2 items-center">
                  <a href="https://zingy-toffee-3afe20.netlify.app/">
                    <h1 className=" text-blue-500 text-xl cursor-pointer hover:underline">
                      Portfolio template-
                    </h1>
                  </a>
            ...
            <div className=" flex gap-5">
              ...
              <div className=" md:flex flex-col">
                <div className=" md:flex gap-2 items-center">
                  <a href="https://roaring-mandazi-c9ebf0.netlify.app/">
                    <h1 className=" text-blue-500 text-xl cursor-pointer hover:underline">
                      Links in bio-
                    </h1>
                  </a>
            ...
            <div className=" flex gap-5">
              ...
              <div className=" md:flex flex-col">
                <div className=" md:flex gap-2 items-center">
                  ...
                  <h1 className=" text-gray-300">
                    {" "}
                    A website for an educational board:-
                  </h1>
                </div>
                <h1 className=" text-gray-300">
                  Its also a complete MERN stack web application. 
                </h1>
              </div>
            </div>
            <div className=" flex gap-5">
              ...
              <div className=" md:flex flex-col">
                <div className=" md:flex gap-2 items-center">
                  <a href="https://abrartravelwings.com/">
                    <h1 className=" text-blue-500 text-xl cursor-pointer hover:underline">
                      Abrar Travel Wings
                    </h1>
                  </a>
                  <h1 className=" text-gray-300">
                    {" "}
                    Another website for a Travel agency board:-
                  </h1>
                </div>
                <h1 className=" text-gray-300">
                  Its also a complete MERN stack web application. 
